import{c as dt,_ as u,e as I,S as pt,a as le,b as ce,d as Q,w as bt,L as de,s as jt,f as pe,m as Oe,r as he,g as Kt,h as Le,i as ue,o as Qt,H as Re,j as De,k as Be,l as Me}from"./my-notifications-list.CVjqVNTy.js";import{g as Ne,i as U,x,f as Rt,h as We,k as He}from"./notifications-client.BPN4HXTv.js";import{a as f,t as Dt,n as Fe}from"./property.CxBSxXjq.js";import{_ as ht}from"./tslib.es6.kHcLnhpD.js";import{S as fe}from"./signal-watcher.Df3ivjzs.js";import{n as Ie}from"./context.Dz-EYhNW.js";function ge(t){return{attribute:t,type:Object,hasChanged:(e,o)=>(e==null?void 0:e.toString())!==(o==null?void 0:o.toString()),converter:e=>e&&e.length>0&&Ne(e)}}var je=U`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`,xt=class extends pt{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return x`
    ...
    `}};xt.styles=[dt,jo];u([f({reflect:!0})],xt.prototype,"variant",2);u([f({type:Boolean,reflect:!0})],xt.prototype,"pill",2);u([f({type:Boolean,reflect:!0})],xt.prototype,"pulse",2);xt.define("sl-badge");var Ko=U`
  :host {
...
`,Ae=class extends pt{constructor(){super(...arguments),this.hasSlotController=new Re(this,"footer","header","image")}render(){return x`
    ...
    `}};Ae.styles=[dt,Ko];Ae.define("sl-card");var Uo=U`
  :host {
    display: inline-block;
  }
