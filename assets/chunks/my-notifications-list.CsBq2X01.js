import{i as w,f as bt,w as ft,x as h,T as Et,l as rt,m as st}from"./notifications-client.dX80mX3r.js";import{S as Mt}from"./signal-watcher.CateQWBy.js";import{s as Tt,n as a,t as It}from"./property.BuCzKQXC.js";import{n as Bt}from"./context.CLB4ygDo.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function Nt({context:t,subscribe:e}){return(o,r)=>{typeof r=="object"?r.addInitializer(function(){new it(this,{context:t,callback:s=>{this[r.name]=s},subscribe:e})}):o.constructor.addInitializer(s=>{new it(s,{context:t,callback:i=>{s[r]=i},subscribe:e})})}}/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ot=(t,e,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(t,e,o),o);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(t,e){return(o,r,s)=>{const i=l=>{var c;return((c=l.renderRoot)==null?void 0:c.querySelector(t))??null};return Ot(o,r,{get(){return i(this)}})}}const Pt=[w`
    .row {
      display: flex;
      flex-direction: row;
    }
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},mt=t=>(...e)=>({_$litDirective$:t,values:e});let gt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,o,r){this._$Ct=e,this._$AM=o,this._$Ci=r}_$AS(e,o){return this.update(e,o)}update(e,o){return this.render(...o)}};function H(t){return`data:image/svg+xml;utf8,${Dt(t)}`}function Dt(t){return`<svg style='fill: currentColor' viewBox='0 0 24 24'><path d='${t}'></path></svg>`}var Ee="M11,15H13V17H11V15M11,7H13V13H11V7M12,2C6.47,2 2,6.5 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20Z",Me="M21,19V20H3V19L5,17V11C5,7.9 7.03,5.17 10,4.29C10,4.19 10,4.1 10,4A2,2 0 0,1 12,2A2,2 0 0,1 14,4C14,4.1 14,4.19 14,4.29C16.97,5.17 19,7.9 19,11V17L21,19M14,21A2,2 0 0,1 12,23A2,2 0 0,1 10,21",Ft="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",jt="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z",Rt="M5,13H19V11H5M3,17H17V15H3M7,7V9H21V7",S=w`
  :host {
...
`,X="";function lt(t){X=t}function Kt(t=""){if(!X){const e=[...document.getElementsByTagName("script")],o=e.find(r=>r.hasAttribute("data-shoelace"));if(o)lt(o.getAttribute("data-shoelace"));else{const r=e.find(i=>/shoelace(\.min)?\.js($|\?)/.test(i.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(i.src));let s="";r&&(s=r.getAttribute("src")),lt(s.split("/").slice(0,-1).join("/"))}}return X.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var Qt={name:"default",resolver:t=>Kt(`assets/icons/${t}.svg`)},te=Qt,ct={caret:`
  ...
  `},ee={name:"system",resolver:t=>t in ct?`data:image/svg+xml,${encodeURIComponent(ct[t])}`:""},oe=ee,re=[te,oe],J=[];function se(t){J.push(t)}function ie(t){J=J.filter(e=>e!==t)}function ut(t){return re.find(e=>e.name===t)}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ne=(t,e)=>(t==null?void 0:t._$litType$)!==void 0;var A=Symbol(),O=Symbol(),q,W=new Map,g=class extends m{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var o;let r;if(e!=null&&e.spriteSheet){this.svg=h`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`,await this.updateComplete;const s=this.shadowRoot.querySelector("[part='svg']");return typeof e.mutator=="function"&&e.mutator(s),this.svg}try{if(r=await fetch(t,{mode:"cors"}),!r.ok)return r.status===410?A:O}catch{return O}try{const s=document.createElement("div");s.innerHTML=await r.text();const i=s.firstElementChild;if(((o=i==null?void 0:i.tagName)==null?void 0:o.toLowerCase())!=="svg")return A;q||(q=new DOMParser);const c=q.parseFromString(i.outerHTML,"text/html").body.querySelector("svg");return c?(c.part.add("svg"),document.adoptNode(c)):A}catch{return A}}connectedCallback(){super.connectedCallback(),se(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),ie(this)}getIconSource(){const t=ut(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;const{url:e,fromLibrary:o}=this.getIconSource(),r=o?ut(this.library):void 0;if(!e){this.svg=null;return}let s=W.get(e);if(s||(s=this.resolveIcon(e,r),W.set(e,s)),!this.initialRender)return;const i=await s;if(i===O&&W.delete(e),e===this.getIconSource().url){if(ne(i)){this.svg=i;return}switch(i){case O:case A:this.svg=null,this.emit("sl-error");break;default:this.svg=i.cloneNode(!0),(t=r==null?void 0:r.mutator)==null||t.call(r,this.svg),this.emit("sl-load")}}}render(){return this.svg}};g.styles=[S,Jt];n([$()],g.prototype,"svg",2);n([a({reflect:!0})],g.prototype,"name",2);n([a()],g.prototype,"src",2);n([a()],g.prototype,"label",2);n([a({reflect:!0})],g.prototype,"library",2);n([R("label")],g.prototype,"handleLabelChange",1);n([R(["name","src","library"])],g.prototype,"setIcon",1);g.define("sl-icon");/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const St="important",ae=" !"+St,dt=mt(class extends gt{constructor(t){var e;if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="style"||((e=t.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,o)=>{const r=t[o];return r==null?e:e+`${o=o.includes("-")?o:o.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(t,[e]){const{style:o}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const r of this.ft)e[r]==null&&(this.ft.delete(r),r.includes("-")?o.removeProperty(r):o[r]=null);for(const r in e){const s=e[r];if(s!=null){this.ft.add(r);const i=typeof s=="string"&&s.endsWith(ae);r.includes("-")||i?o.setProperty(r,i?s.slice(0,-11):s,i?St:""):o[r]=s}}return ft}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const le=t=>typeof t!="string"&&"strTag"in t,ce=(t,e,o)=>{let r=t[0];for(let s=1;s<t.length;s++)r+=e[s-1],r+=t[s];return r};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ue=t=>le(t)?ce(t.strings,t.values):t;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class de{constructor(){this.settled=!1,this.promise=new Promise((e,o)=>{this._resolve=e,this._reject=o})}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}/**
 * @license
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lt=Symbol.for(""),ve=t=>{if((t==null?void 0:t.r)===Lt)return t==null?void 0:t._$litStatic$},j=(t,...e)=>({_$litStatic$:e.reduce((o,r,s)=>o+(i=>{if(i._$litStatic$!==void 0)return i._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${i}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(r)+t[s+1],t[0]),r:Lt}),ht=new Map,me=t=>(e,...o)=>{const r=o.length;let s,i;const l=[],c=[];let b,p=0,u=!1;for(;p<r;){for(b=e[p];p<r&&(i=o[p],(s=ve(i))!==void 0);)b+=s+e[++p],u=!0;p!==r&&c.push(i),l.push(b),p++}if(p===r&&l.push(e[r]),u){const x=l.join("$$lit$$");(e=ht.get(x))===void 0&&(l.raw=l,ht.set(x,e=l)),o=c}return t(e,...o)},F=me(h);var v=class extends m{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?j`a`:j`button`;return F`
      <${e}
        part="base"
    ...
    `}};v.styles=[S,pe];v.dependencies={"sl-icon":g};n([pt(".icon-button")],v.prototype,"button",2);n([$()],v.prototype,"hasFocus",2);n([a()],v.prototype,"name",2);n([a()],v.prototype,"library",2);n([a()],v.prototype,"src",2);n([a()],v.prototype,"href",2);n([a()],v.prototype,"target",2);n([a()],v.prototype,"download",2);n([a()],v.prototype,"label",2);n([a({type:Boolean,reflect:!0})],v.prototype,"disabled",2);v.define("sl-icon-button");var ge=w`
  :host {
    --track-width: 2px;
...
`,d=class extends m{constructor(){super(...arguments),this.formControlController=new ye(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new fe(this,"[default]","prefix","suffix"),this.localize=new Q(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:et}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?j`a`:j`button`;return F`
    ...
    `}};d.styles=[S,we];d.dependencies={"sl-icon":g,"sl-spinner":At};n([pt(".button")],d.prototype,"button",2);n([$()],d.prototype,"hasFocus",2);n([$()],d.prototype,"invalid",2);n([a()],d.prototype,"title",2);n([a({reflect:!0})],d.prototype,"variant",2);n([a({reflect:!0})],d.prototype,"size",2);n([a({type:Boolean,reflect:!0})],d.prototype,"caret",2);n([a({type:Boolean,reflect:!0})],d.prototype,"disabled",2);n([a({type:Boolean,reflect:!0})],d.prototype,"loading",2);n([a({type:Boolean,reflect:!0})],d.prototype,"outline",2);n([a({type:Boolean,reflect:!0})],d.prototype,"pill",2);n([a({type:Boolean,reflect:!0})],d.prototype,"circle",2);n([a()],d.prototype,"type",2);n([a()],d.prototype,"name",2);n([a()],d.prototype,"value",2);n([a()],d.prototype,"href",2);n([a()],d.prototype,"target",2);n([a()],d.prototype,"rel",2);n([a()],d.prototype,"download",2);n([a()],d.prototype,"form",2);n([a({attribute:"formaction"})],d.prototype,"formAction",2);n([a({attribute:"formenctype"})],d.prototype,"formEnctype",2);n([a({attribute:"formmethod"})],d.prototype,"formMethod",2);n([a({attribute:"formnovalidate",type:Boolean})],d.prototype,"formNoValidate",2);n([a({attribute:"formtarget"})],d.prototype,"formTarget",2);n([R("disabled",{waitUntilFirstUpdate:!0})],d.prototype,"handleDisabledChange",1);d.define("sl-button");var _e=w`
  :host {
...
`,U=class extends m{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};U.styles=[S,_e];n([a({type:Boolean,reflect:!0})],U.prototype,"vertical",2);n([R("vertical")],U.prototype,"handleVerticalChange",1);U.define("sl-divider");var xe=[{max:276e4,value:6e4,unit:"minute"},{max:72e6,value:36e5,unit:"hour"},{max:5184e5,value:864e5,unit:"day"},{max:24192e5,value:6048e5,unit:"week"},{max:28512e6,value:2592e6,unit:"month"},{max:1/0,value:31536e6,unit:"year"}],_=class extends m{constructor(){super(...arguments),this.localize=new Q(this),this.isoTime="",this.relativeTime="",this.titleTime="",this.date=new Date,this.format="long",this.numeric="auto",this.sync=!1}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.updateTimeout)}render(){const t=new Date,e=new Date(this.date);if(isNaN(e.getMilliseconds()))return this.relativeTime="",this.isoTime="","";const o=e.getTime()-t.getTime(),{unit:r,value:s}=xe.find(i=>Math.abs(o)<i.max);if(this.isoTime=e.toISOString(),this.titleTime=this.localize.date(e,{month:"long",year:"numeric",day:"numeric",hour:"numeric",minute:"numeric",timeZoneName:"short"}),this.relativeTime=this.localize.relativeTime(Math.round(o/s),r,{numeric:this.numeric,style:this.format}),clearTimeout(this.updateTimeout),this.sync){let i;r==="minute"?i=D("second"):r==="hour"?i=D("minute"):r==="day"?i=D("hour"):i=D("day"),this.updateTimeout=window.setTimeout(()=>this.requestUpdate(),i)}return h` <time datetime=${this.isoTime} title=${this.titleTime}>${this.relativeTime}</time> `}};n([$()],_.prototype,"isoTime",2);n([$()],_.prototype,"relativeTime",2);n([$()],_.prototype,"titleTime",2);n([a()],_.prototype,"date",2);n([a()],_.prototype,"format",2);n([a()],_.prototype,"numeric",2);n([a({type:Boolean})],_.prototype,"sync",2);function D(t){const o={second:1e3,minute:6e4,hour:36e5,day:864e5}[t];return o-Date.now()%o}_.define("sl-relative-time");var ke=Object.defineProperty,$e=Object.getOwnPropertyDescriptor,Vt=(t,e,o,r)=>{for(var s=r>1?void 0:r?$e(e,o):e,i=t.length-1,l;i>=0;i--)(l=t[i])&&(s=(r?l(e,o,s):l(s))||s);return r&&s&&ke(e,o,s),s};let M=class extends Mt(bt){renderNotificationGroup(t,e,o,r){const s=o.notifications.length===1;return h`<div
		...
		`];Vt([Nt({context:Bt,subscribe:!0})],M.prototype,"notificationsStore",2);M=Vt([It("my-notifications-list")],M);const Ie=Object.freeze(Object.defineProperty({__proto__:null,get MyNotifications(){return M}},Symbol.toStringTag,{value:"Module"}));export{fe as H,Q as L,m as S,n as _,wt as a,T as b,S as c,K as d,pt as e,H as f,Z as g,g as h,Nt as i,f as j,At as k,Me as l,Ee as m,Ie as n,dt as o,$ as r,Pt as s,R as w};
