...
/// Internal type RegisterClass: defined at src/isa/x64/inst.isle line 1356.
#[derive(Clone, Debug)]
...
/// Internal type ExtendKind: defined at src/isa/x64/inst.isle line 1466.
...
/// Internal type IcmpCondResult: defined at src/isa/x64/inst.isle line 3408.
#[derive(Clone, Debug)]
pub enum IcmpCondResult {
    Condition { producer: ProducesFlags, cc: CC },
}

/// Internal type FcmpCondResult: defined at src/isa/x64/inst.isle line 3510.
#[derive(Clone, Debug)]
                                ...
                                if let &Opcode::Iconst = pattern12_0 {
                                    if let Some(pattern14_0) = C::uimm8(ctx, pattern12_1) {
                                        ...
                                        if let Some(pattern15_0) = closure15() {
                                            ...
                                            let expr1_0 = constructor_put_in_gpr(ctx, pattern9_0)?;
...
pub fn constructor_vector_all_ones<C: Context>(ctx: &mut C) -> Option<Xmm> {
    // Rule at src/isa/x64/inst.isle line 1541.
...
pub fn constructor_x64_load<C: Context>(
    ...
    if pattern0_0 == F64 {
        let pattern2_0 = arg1;
        let pattern3_0 = arg2;
        // Rule at src/isa/x64/inst.isle line 1602.
...
pub fn constructor_x64_add_with_flags_paired<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/x64/inst.isle line 1725.
    let expr0_0 = C::temp_writable_gpr(ctx);
    let expr1_0 = C::operand_size_of_type_32_64(ctx, pattern0_0);
...
pub fn constructor_x64_sub_with_flags_paired<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/x64/inst.isle line 1757.
    let expr0_0 = C::temp_writable_gpr(ctx);
    let expr1_0 = C::operand_size_of_type_32_64(ctx, pattern0_0);
    ...
    match pattern0_0 {
        &FloatCC::Equal => {
            ...
            if let Some(pattern4_0) = C::ty_scalar_float(ctx, pattern3_0) {
                let pattern5_0 = arg2;
                // Rule at src/isa/x64/inst.isle line 3563.
